...
- (IBAction)AddRatingsectionTouchUpInside:(id)sender {
   ...
   // NSString* newRatingsectionStartPosition = [NSString stringWithFormat:@"Abschnitt"];
    ...
    NSString *newRatingsectionStartPosition = [NSString stringWithFormat:@"%@,%@", self.latidude, self.longitude];
   ...
   // NSLog(@"Add Rating Section");
    ...
    NSLog(@"Current Position: %@, %@", self.longitude, self.latidude);
...
- (void)locationManager:(CLLocationManager *)manager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)oldLocation
{
    ...
    if (currentLocation != nil) {
        ...
        NSLog(@"Position %@ %@", self.longitude, self.latidude);
