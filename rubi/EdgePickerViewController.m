...
@interface EdgePickerViewController ()

@end

@implementation EdgePickerViewController
...
{
    [super viewDidLoad];
    self.constructionTypes = [[NSMutableArray alloc] initWithObjects: @"Bankett", @"Beton", @"Naturstein", @"Sonstige Bauweise", nil];
